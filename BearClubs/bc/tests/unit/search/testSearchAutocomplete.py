...
class SearchAutocompleteUnitTests(TestCase):
    ...
    def setUp(self):
        ...
        Event(name='test event', description='event description', organization=Organization.objects.get(name='Test 1'),  start_time=timezone.now(), end_time=timezone.now()).save();
